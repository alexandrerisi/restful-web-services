...
import com.in28minutes.rest.webservices.restfulwebservices.exception.AuthenticationException;
...
public class JwtAuthenticationRestController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtTokenRequest authenticationRequest)
        ...
        var userDetails = todoUserDetailsService.loadUserByUsername(authenticationRequest.getUsername());
    ...
    public ResponseEntity<?> refreshAndGetAuthenticationToken(HttpServletRequest request) {
        ...
        //var user = (UserDetails) userDetailsService.loadUserByUsername(username);
